...
class Header extends Component{
    ...
    render(){
        return(
            // React Fragment(<React.Fragment></React.Fragment> or <></>) --> It enables us to group together 
            // branch of react elemnets, actually alternative of div tag.   
            <>
                <Navbar dark expand="md">
                    <div className="container">
                        <NavbarToggler onClick={this.toggleNav} />
                        <NavbarBrand className="mr-auto" href="/">
                            <img src='assets/images/logo.png' height="30" width="41" alt='The Food Shop' />
                        </NavbarBrand>
