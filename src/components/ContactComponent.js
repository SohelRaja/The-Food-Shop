...
class Contact extends Component{
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.touched.telnum && !reg.test(telnum)){
            ...
            errors.telnum = "Tel. Number should contain with exactly 10 numbers.";
        }
            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                            ...
                            <i className="fa fa-envelope"></i>: <a href="mailto:tfs@food.net">tfs@food.net</a>
                            </address>
                    </div>
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-success" href="mailto:tfs@food.net"><i className="fa fa-envelope-o"></i> Email</a>
                        </div>
                    </div>
                </div>
                <div className="row row-content">
